    ...
    try:
        ...
        if "mbasic_logout_button" in str(ismi):
            ...
            try:
                ...
                x["fb_dtsg"] = joe[1]
                x["jazoest"] = joe[2]
                kata = ["Toolsnya Mantap bro","Toolsnya Gila sih","Buat Fitur Yg Lain bro","sips","makasih toolsnya","gak ada obat toolsnya","sukses selalu bro","gua selalu suport lu bro","hah","wkwkkkwk ngakak"]
